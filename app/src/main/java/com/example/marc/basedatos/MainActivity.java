package com.example.marc.basedatos;
...
public class MainActivity extends ActionBarActivity {
    ...
    public void alta (View v){
        ...
        //para cambiar de idioma se le agrega el R String despues de THIS
    ...
    public void consulta(View v) {
        AdminSQLiteOpenHelper admin = new AdminSQLiteOpenHelper(this, "usuarios", null, 1); SQLiteDatabase bd = admin.getWritableDatabase();
        String idusuario = et_idusuario.getText().toString();
        // en esta condicion se le dicta cuales son los campos que debe mostrar al precinar el boton consulta de misma forma cursor es una clase
    ...
    public void baja(View v) {
        ...
        // el setText se usa para limpiar
